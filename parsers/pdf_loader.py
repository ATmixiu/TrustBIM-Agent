...
def _paths():
    if _project_dir:
        return (os.path.join(_project_dir, "architectural.pdf"),
                os.path.join(_project_dir, "structural.pdf"))
    return (os.path.join(DATA, "architectural.pdf"),
            os.path.join(DATA, "structural.pdf"))
